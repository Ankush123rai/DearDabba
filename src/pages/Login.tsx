  ...
  return (
    <FirstLayout>
      <div className="flex flex-col items-center min-h-screen px-4">
        ...
        {isSent ? (
          <div className="w-full rounded-2xl max-w-[400px] bg-white p-4 text-center shadow-2xl">
            ...
            <div className="text-center max-w-md mx-auto space-y-4">
              ...
              <p className="text-gray-500">
                Enter the verification code sent on XXXXXX7214
              </p>
              ...
              <div className="flex justify-center space-x-4">
                {otp.map((digit, idx) => (
                  <input
                    ...
                    className="w-12 sm:w-[75px] h-12 sm:h-[75px] border-none bg-[#EFEFEF] rounded-2xl text-center text-xl font-semibold focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ))}
              </div>
              ...
              <button
                className={`w-full py-3 rounded-lg transition-colors ${
                  otp.every((d) => d !== "")
                    ...
                    : "bg-[#EFEFEF] text-white cursor-not-allowed"
                }`}
          ...
          <div className="w-full max-w-[400px] bg-white p-4 text-center">
            ...
            <div className="bg-[#EFEFEF] rounded-2xl px-6 py-2 mb-3 flex flex-col justify-start">
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 rounded-lg transition mb-4"
            >
              OTP
            </button>
            ...
            <div className="flex justify-center gap-4 mb-6">
              ...
              <button className="border p-3 rounded-lg hover:bg-gray-100 transition">
                <FaFacebook className="text-[17px] text-blue-600" />
              </button>
            </div>
