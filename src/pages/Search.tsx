...
const Search = () => {
  ...
  const dummyDataType = {
    Restaurant: ["Spice Hub", "Urban Tadka", "The Tandoori House", "Nagpur Kitchen"],
    "Tiffin Services": ["Rai Tiffin Center", "Mom's Kitchen", "Healthy Tiffins"],
  ...
  return (
    <div className="mx-4 md:mx-8">
      ...
      <div className="relative mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[95%] md:max-w-[1200px]">
        <div className="relative bg-white rounded-3xl overflow-hidden aspect-[16/9] md:aspect-auto md:h-[464px]">
          <div className="absolute inset-0 md:w-[694px] md:h-[464px] md:left-[-192px]">
            <img src={topTrend} alt="Top Trending Spots" className="w-full h-full object-cover" />
          </div>
          <div className="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-[#2B2614]" />
          <div className="absolute bottom-6 w-full flex items-center justify-center px-4">
            <div className="backdrop-blur-sm bg-white/10 px-4 py-2 rounded-lg">
              <h2 className="text-white font-poppins font-semibold text-[24px] md:text-[30px] leading-tight text-center capitalize">
                Top Trending Spots
              </h2>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between gap-4">
          {[insta, romantc].map((img, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 w-full h-1/2 bg-gradient-to-b from-transparent to-[#332D19]" />
              <div className="absolute bottom-4 w-full flex items-center justify-center px-4">
                <div className="backdrop-blur-sm bg-white/10 px-4 py-2 rounded-lg">
                  <h2 className="text-white font-poppins font-semibold text-[20px] md:text-[30px] leading-tight text-center capitalize">
