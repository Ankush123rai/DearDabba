...
const Setting = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'You can track your order from the "My Orders" section in real time.',
    },
    {
      question: "What if my order is late?",
      answer: "If your order is late, contact support through the Help Center.",
    },
    {
      question: "Can I cancel my order?",
      answer: "Yes, you can cancel before the restaurant confirms it.",
    },
    {
      question: "What happens if I receive the wrong order?",
      answer: "Reach out to support immediately for a resolution.",
    },
  ];
